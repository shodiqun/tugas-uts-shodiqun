...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    // Query untuk mengambil data paramedik berdasarkan id
...
if (isset($_POST['submit'])) {
    ...
    // Query SQL untuk update data paramedik berdasarkan id
                        ...
                        <div class="card-body">
                            ...
                            <form action="edit.php?id=<?= $row['id'] ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <select id="kategori" name="kategori" class="custom-select">
                                            ...
                                            <option value="dokter_gigi" <?= ($row['kategori'] == 'dokter_gigi') ? 'selected' : '' ?>>Dokter Gigi</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <?php
                                        $sqlunit = "SELECT * FROM unit_kerja";
                                        $rsunit = $dbh->query($sqlunit);
                                        ?>
                                        <select id="unit_kerja_id" name="unit_kerja_id" class="custom-select">
                                            <?php
                                            foreach ($rsunit as $rowunit) {
                                                $selected = ($row['unit_kerja_id'] == $rowunit['id']) ? 'selected' : '';
                                                echo "<option value='" . $rowunit['id'] . "' $selected>" . $rowunit['nama'] . "</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
